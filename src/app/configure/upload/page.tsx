...
import { Image, Loader2, MousePointerSquareDashed, Users } from "lucide-react";
  ...
  return (
    <div
      className={cn(
        ...
        {
          "ring-blue-900/25 bg-blue-900/10": isDropOver,
        }
      )}
    >
      <div className="relative flex flex-1 flex-col items-center justify-center w-full h-full">
        <Dropzone
          ...
          onDragLeave={() => setIsDropOver(true)}
        >
              ...
              >
                ...
                <div className="flex flex-col justify-center mb-2 text-sm text-zinc-700">
                  {isUploading ? (
                    ...
                    <p>
                      <span className="font-semibold">Drop File</span> or drag
                      and drop
                    </p>
                  )}
                </div>

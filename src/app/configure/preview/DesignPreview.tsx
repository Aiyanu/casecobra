...
function DesignPreview({ configuration }: { configuration: Configuration }) {
  ...
  return (
    <>
      <div className="pointer-events-none absolute select-none inset-0 overflow-hidden flex justify-center">
        <Confetti
          active={showConfetti}
      ...
      <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gax8 lg:gap-x-12">
          ...
          <div className="mt-8">
            <div className="bg-gray-50 p-6 sm:rounded-lg sm:p-8">
              <div className="flow-root text-sm">
                ...
                <div className="mr-2 h-px bg-gray-200" />
